  ...
  return (
    <>
      <div className="post-comment-item-box" key={comment.id}>
        <div className="profile profile-small" style={{backgroundImage: `url("${comment.commentBelongsToUser.profile}")`}}></div>
        <div className="post-comment-item-comment">
          <div className="post-comment-item-comment-info">
            <p className='post-comment-item-item-nick'>{comment.commentBelongsToUser.nick}</p>
