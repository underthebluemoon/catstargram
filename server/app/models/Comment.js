...
const Comment = {
  ...
  associate: (db) => {
    db.Comment.belongsTo(db.User, { targetKey: 'id', foreignKey: 'userId', as: 'commentBelongsToUser' });
    db.Comment.belongsTo(db.Post, { targetKey: 'id', foreignKey: 'postId', as: 'commentBelongsToPost' });
  },
}
